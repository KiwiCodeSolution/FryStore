...
const BaseButton: React.FC<BaseBtnProps> = props => {
	...
	const baseStyle =
		'block border-box cursor-pointer flex justify-center items-center transition-all duration-300 font-bold min-h-[48px] px-6 py-1 rounded-3xl hover:scale-105'
